...
namespace G4.Plugins.Common.Transformers
{
    [G4Plugin(
        ...
        manifest: $"G4.Plugins.Common.Transformers.Manifests.{nameof(Trim)}.json")]
    public class Trim(G4PluginSetupModel pluginSetup) : PluginBase(pluginSetup)
    {
