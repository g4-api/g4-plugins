...
namespace G4.Plugins.Common.Operators
{
    [G4Plugin(
        ...
        manifest: $"G4.Plugins.Common.Operators.Manifests.{nameof(EqualOperator)}.json")]
    public class EqualOperator(G4PluginSetupModel pluginSetup) : PluginBase(pluginSetup)
    {
