...
namespace G4.Plugins.Ui.Actions
{
    ...
    public class RedoNavigation(G4PluginSetupModel pluginSetup) : PluginBase(pluginSetup)
    {
        ...
        protected override PluginResponseModel OnSend(PluginDataModel pluginData)
        {
            ...
            // Execute the browser redo or forward navigation action through the shared helper.
            methodBase.CallNavigate(
                pluginData,
                navigationAction: () => WebDriver.Navigate().Redo());
