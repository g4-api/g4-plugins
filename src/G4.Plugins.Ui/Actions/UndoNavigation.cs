...
namespace G4.Plugins.Ui.Actions
{
    ...
    public class UndoNavigation(G4PluginSetupModel pluginSetup) : PluginBase(pluginSetup)
    {
        ...
        protected override PluginResponseModel OnSend(PluginDataModel pluginData)
        {
            ...
            // Execute the browser undo or backward navigation action through the shared helper.
            methodBase.CallNavigate(
                pluginData,
                navigationAction: () => WebDriver.Navigate().Undo());
