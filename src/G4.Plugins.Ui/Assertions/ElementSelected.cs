...
namespace G4.Plugins.Ui.Assertions
{
    [G4Plugin(
        ...
        manifest: $"G4.Plugins.Ui.Assertions.Manifests.{nameof(ElementSelected)}.json")]
    public class ElementSelected(G4PluginSetupModel pluginSetup) : PluginBase(pluginSetup)
    {
