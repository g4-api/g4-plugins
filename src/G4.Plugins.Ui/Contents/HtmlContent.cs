...
namespace G4.Plugins.Ui.Contents
{
    [G4Plugin(
        ...
        manifest: $"G4.Plugins.Ui.Contents.Manifests.{nameof(HtmlContent)}.json")]
    public class HtmlContent(G4PluginSetupModel pluginSetup) : PluginBase(pluginSetup)
    {
        protected override PluginResponseModel OnSend(PluginDataModel pluginData)
        {
            ...
            var htmlNode = new HtmlDocument().ImportHtml(pluginData.HtmlNode.OuterHtml).DocumentNode;
