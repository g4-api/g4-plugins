...
{
    internal class C0022(TestContext context) : TestCaseBase(context)
    {
        protected override IEnumerable<G4RuleModelBase> OnActions(AutomationEnvironment environment)
        {
            ...
            return
            [
                // InvokeClick action: Simulates a click on the element with the ID "NewAlertButton".
                new ActionRuleModel
                {
                ...
                // SetCondition action: Sets a condition based on whether an alert does not exist.
                new SwitchRuleModel
                {
