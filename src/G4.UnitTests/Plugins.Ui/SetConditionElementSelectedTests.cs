...
namespace G4.UnitTests.Plugins.Ui
{
    ...
    public class SetConditionElementSelectedTests : TestBase
    {
        // Define a data set for the ElementSelected plugin
        private static IEnumerable<object[]> DataSet =>
        [
            [Stubs.RuleJsonConditionDynamic, "ElementSelected"],
            [Stubs.RuleJsonConditionDynamic, "elementSelected"],
            [Stubs.RuleJsonConditionDynamic, "Selected"],
            [Stubs.RuleJsonConditionDynamic, "selected"]
        ];

        [TestMethod(DisplayName = "Verify that element is selected with various positive conditions")]
        #region *** Data Set ***
        [DynamicData(nameof(DataSet))]
        #endregion
        public void ElementSelectedTest(string ruleJson, string condition)
        {
        ...
        [TestMethod(DisplayName = "Verify that the ElementSelected condition fails for various " +
            "conditions with first-layer elements.")]
        #region *** Data Set ***
        [DynamicData(nameof(DataSet))]
        #endregion
        public void ElementSelectedNoSuchElementExceptionTest(string ruleJson, string condition)
        {
        ...
        [DynamicData(nameof(DataSet))]
        #endregion
        public void ElementSelectedNegativeTest(string ruleJson, string condition)
        {
            // Replace placeholders in the rule JSON with the specified values.
            ruleJson = ruleJson
        ...
        [TestMethod(DisplayName = "Verify that the ElementSelected condition handles " +
            "StaleElementReferenceException for first-layer elements.")]
        #region *** Data Set ***
        [DynamicData(nameof(DataSet))]
        #endregion
        public void ElementSelectedStaleElementTest(string ruleJson, string condition)
        {
            // Replace placeholders in the rule JSON with the specified values.
            ruleJson = ruleJson
        ...
        [DynamicData(nameof(DataSet))]
        #endregion
        public void ElementSelectedWebDriverExceptionTest(string ruleJson, string condition)
        {
            // Replace placeholders in the rule JSON with the specified values.
            ruleJson = ruleJson
        ...
        [TestMethod(DisplayName = "Verify that element is selected when null with various assertions")]
        #region *** Data Set ***
        [DynamicData(nameof(DataSet))]
        #endregion
