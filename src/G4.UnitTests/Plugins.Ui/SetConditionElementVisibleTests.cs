...
namespace G4.UnitTests.Plugins.Ui
{
    ...
    public class SetConditionElementVisibleTests : TestBase
    {
        // Define a data set for the ElementVisible plugin
        private static IEnumerable<object[]> DataSet =>
        [
            [Stubs.RuleJsonConditionDynamic, "ElementVisible"],
            [Stubs.RuleJsonConditionDynamic, "elementVisible"],
            [Stubs.RuleJsonConditionDynamic, "Visible"],
            [Stubs.RuleJsonConditionDynamic, "visible"],
            [Stubs.RuleJsonConditionDynamic, "Displayed"],
            [Stubs.RuleJsonConditionDynamic, "displayed"]
        ];

        [TestMethod(DisplayName = "Verify that element is visible with various positive conditions")]
        #region *** Data Set ***
        [DynamicData(nameof(DataSet))]
        #endregion
        public void ElementVisibleTest(string ruleJson, string condition)
        {
        ...
        [TestMethod(DisplayName = "Verify that the ElementVisible condition fails for various " +
            "conditions with first-layer elements.")]
        #region *** Data Set ***
        [DynamicData(nameof(DataSet))]
        #endregion
        public void ElementVisibleNoSuchElementExceptionTest(string ruleJson, string condition)
        {
        ...
        [DynamicData(nameof(DataSet))]
        #endregion
        public void ElementVisibleNegativeTest(string ruleJson, string condition)
        {
            // Replace placeholders in the rule JSON with the specified values.
            ruleJson = ruleJson
        ...
        [TestMethod(DisplayName = "Verify that the ElementVisible condition handles " +
            "StaleElementReferenceException for first-layer elements.")]
        #region *** Data Set ***
        [DynamicData(nameof(DataSet))]
        #endregion
        public void ElementVisibleStaleElementTest(string ruleJson, string condition)
        {
            // Replace placeholders in the rule JSON with the specified values.
            ruleJson = ruleJson
        ...
        [DynamicData(nameof(DataSet))]
        #endregion
        public void ElementVisibleWebDriverExceptionTest(string ruleJson, string condition)
        {
            // Replace placeholders in the rule JSON with the specified values.
            ruleJson = ruleJson
        ...
        [TestMethod(DisplayName = "Verify that element is visible when null with various assertions")]
        #region *** Data Set ***
        [DynamicData(nameof(DataSet))]
        #endregion
