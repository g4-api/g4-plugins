...
namespace G4.UnitTests.Plugins.Ui
{
    ...
    public class AssertElementNotSelectedTests : TestBase
    {
        ...
        #endregion
        public void ElementNotSelectedNegativeTest(string ruleJson, string assertion)
        {
        ...
        [DynamicData(dynamicDataSourceName: nameof(DataSet))]
        #endregion
        public void ElementNotSelectedNoneTest(string ruleJson, string condition)
        {
            // Replace placeholders in the rule JSON with specific test values
            ruleJson = ruleJson
        ...
        [DynamicData(dynamicDataSourceName: nameof(DataSet))]
        #endregion
        public void ElementNotSelectedStaleTest(string ruleJson, string condition)
        {
            // Replace placeholders in the rule JSON with specific test values
            ruleJson = ruleJson
        ...
        [DynamicData(dynamicDataSourceName: nameof(DataSet))]
        #endregion
        public void ElementNotSelectedTest(string ruleJson, string assertion)
        {
            // Replace placeholders in the rule JSON with specific test values
            ruleJson = ruleJson
