...
namespace G4.UnitTests.Plugins.Ui
{
    ...
    public class SetConditionElementNotActiveTests : TestBase
    {
        // Define a data set for the ElementNotActive plugin
        private static IEnumerable<object[]> DataSet =>
        [
            [Stubs.RuleJsonConditionDynamic, "ElementNotActive"],
            [Stubs.RuleJsonConditionDynamic, "elementNotActive"],
            [Stubs.RuleJsonConditionDynamic, "NotActive"],
            [Stubs.RuleJsonConditionDynamic, "notActive"],
            [Stubs.RuleJsonConditionDynamic, "HasNoFocus"],
            [Stubs.RuleJsonConditionDynamic, "hasNoFocus"]
        ];

        [TestMethod(displayName: "Verify that element is not active with various positive conditions")]
        #region *** Data Set ***
        [DynamicData(nameof(DataSet))]
        #endregion
        public void ElementNotActiveTest(string ruleJson, string condition)
        {
        ...
        [TestMethod(displayName: "Verify that the ElementNotActive condition fails for various " +
            "conditions with first-layer elements.")]
        #region *** Data Set ***
        [DynamicData(nameof(DataSet))]
        #endregion
        public void ElementNotActiveNoSuchElementExceptionTest(string ruleJson, string condition)
        {
        ...
        [DynamicData(nameof(DataSet))]
        #endregion
        public void ElementNotActiveNegativeTest(string ruleJson, string condition)
        {
            // Replace placeholders in the rule JSON with the specified values.
            ruleJson = ruleJson
        ...
        [TestMethod(displayName: "Verify that the ElementNotActive condition handles " +
            "StaleElementReferenceException for first-layer elements.")]
        #region *** Data Set ***
        [DynamicData(nameof(DataSet))]
        #endregion
        public void ElementNotActiveStaleElementTest(string ruleJson, string condition)
        {
            // Replace placeholders in the rule JSON with the specified values.
            ruleJson = ruleJson
        ...
        [DynamicData(nameof(DataSet))]
        #endregion
        public void ElementNotActiveWebDriverExceptionTest(string ruleJson, string condition)
        {
            // Replace placeholders in the rule JSON with the specified values.
            ruleJson = ruleJson
