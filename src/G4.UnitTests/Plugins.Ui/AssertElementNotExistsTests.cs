...
namespace G4.UnitTests.Plugins.Ui
{
    ...
    public class AssertElementNotExistsTests : TestBase
    {
        ...
        #endregion
        public void ElementNotExistsNegativeTest(string ruleJson, string assertion)
        {
        ...
        [DynamicData(dynamicDataSourceName: nameof(DataSet))]
        #endregion
        public void ElementNotExistsStaleTest(string ruleJson, string condition)
        {
            // Replace placeholders in the rule JSON with specific test values
            ruleJson = ruleJson
        ...
        [DynamicData(dynamicDataSourceName: nameof(DataSet))]
        #endregion
        public void ElementNotExistsTest(string ruleJson, string assertion)
        {
            // Replace placeholders in the rule JSON with specific test values
            ruleJson = ruleJson
