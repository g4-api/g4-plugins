...
namespace G4.UnitTests.Plugins.Ui
{
    ...
    public class SetConditionElementNotVisibleTests : TestBase
    {
        // Define a data set for the ElementNotVisible plugin
        private static IEnumerable<object[]> DataSet =>
        [
            [Stubs.RuleJsonConditionDynamic, "ElementNotVisible"],
            [Stubs.RuleJsonConditionDynamic, "elementNotVisible"],
            [Stubs.RuleJsonConditionDynamic, "NotVisible"],
            [Stubs.RuleJsonConditionDynamic, "notVisible"]
        ];

        [TestMethod(displayName: "Verify that element is not visible with various positive conditions")]
        #region *** Data Set ***
        [DynamicData(nameof(DataSet))]
        #endregion
        public void ElementNotVisibleTest(string ruleJson, string condition)
        {
        ...
        [TestMethod(displayName: "Verify that the ElementNotVisible condition fails for various " +
            "conditions with first-layer elements.")]
        #region *** Data Set ***
        [DynamicData(nameof(DataSet))]
        #endregion
        public void ElementNotVisibleNoSuchElementExceptionTest(string ruleJson, string condition)
        {
        ...
        [DynamicData(nameof(DataSet))]
        #endregion
        public void ElementNotVisibleNegativeTest(string ruleJson, string condition)
        {
            // Replace placeholders in the rule JSON with the specified values.
            ruleJson = ruleJson
        ...
        [TestMethod(displayName: "Verify that the ElementNotVisible condition handles " +
            "StaleElementReferenceException for first-layer elements.")]
        #region *** Data Set ***
        [DynamicData(nameof(DataSet))]
        #endregion
        public void ElementNotVisibleStaleElementTest(string ruleJson, string condition)
        {
            // Replace placeholders in the rule JSON with the specified values.
            ruleJson = ruleJson
        ...
        [DynamicData(nameof(DataSet))]
        #endregion
        public void ElementNotVisibleWebDriverExceptionTest(string ruleJson, string condition)
        {
            // Replace placeholders in the rule JSON with the specified values.
            ruleJson = ruleJson
        ...
        [TestMethod(displayName: "Verify that element is not visible when null with various assertions")]
        #region *** Data Set ***
        [DynamicData(nameof(DataSet))]
        #endregion
